 ...
 *
 * <p>{@code GarageContainerAws} runs a single (non-distributed) node.
 *
 * <p>To ease the migration from testcontainers-localstack's {@code LocalStackContainer}
 * {@code GarageContainerAws} provides the methods {@link #withServices(String...)},
 ...
 * {@code GarageContainerAws} provides the methods {@link #withUserName(String)},
 ...
 * a client or a client builder that is pre-configured for the garage container.
 */
public class GarageContainerAws extends AbstractGarageContainerAws<GarageContainerAws> {
  /**
   * Construct a Garage container from the dockerImageName.
   *
   * @param dockerImageName the full image name to use
   */
  public GarageContainerAws(final String dockerImageName) {
   ...
   * @param dockerImageName the full image name to use
   */
  public GarageContainerAws(final DockerImageName dockerImageName) {
    super(dockerImageName);
  }
}
